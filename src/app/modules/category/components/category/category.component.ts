...
export class CategoryComponent implements OnInit {
  ...
  constructor(private categoryService: CategoryService, public dialog: MatDialog, private snackBar: MatSnackBar, private util: UtilService) { }
  ...
  exportExcel() {
    this.categoryService.exportCategories().subscribe((data:any) => {
      ...
      this.openSnackBar('Excel de categorias descargado', 'OK');
    });
  }
}
